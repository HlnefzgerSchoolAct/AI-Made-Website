...
class TaskManager {
    ...
    async loadTasks() {
        if (window.storage) {
            this.tasks = await window.storage.getAll('tasks') || [];
        }
    }

    async saveTasks() {
        for (const task of this.tasks) {
            await window.storage.update('tasks', task);
        }
    }
    ...
    async createTask(taskData) {
        ...
        await window.storage.add('tasks', task);
        this.render();
        return task;
    }
    ...
    async deleteTask(id) {
        ...
        await window.storage.delete('tasks', id);
        this.render();
    }
    ...
    createTaskElement(task) {
        ...
        div.innerHTML = `
            <div class="task-header">
                <span class="task-priority" style="background: ${priorityColors[task.priority]}"></span>
        ...
        div.addEventListener('click', () => this.showTaskModal(task));
    ...
    exportTasks() {
        ...
        window.FocusFlowUtils.downloadFile(json, 'tasks.json', 'application/json');
    }
}
